...
- Back-end : socker.io를 활용한 채팅 서버 구현. 커스터마이징 하기 쉽게 API형식의 설계를 진행하였으며, 혹시 서버를 수정하더라도, 이해하기 쉬운 Framework구조로 작성. 클러스터 기법으로 로드밸런싱을 가능하도록 Redis를 적용하여, 채팅방의 정보, 세션, 내역 등을 저장하고 제공
